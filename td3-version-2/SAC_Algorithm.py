...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, n_actions, max_action, fc1_dims, fc2_dims, 
                 fc3_dims, name, checkpoint_dir='SAC_model'):
    ...
    def save_checkpoint(self):
        print('... saving checkpoint ' + name + '_sac ...')
        T.save(self.state_dict(), self.checkpoint_file)

    def load_checkpoint(self):
        print('... loading checkpoint ' + name + '_sac ...')
...
class Agent:
    def __init__(self, alpha, beta, tau, env, input_dims, layer1_size,
                 layer2_size, layer3_size, gamma=0.99, n_actions=7, 
                 max_size=1000000, batch_size=100, checkpoint_dir='SAC_model'):
        self.gamma = gamma
        self.tau = tau
        ...
        self.critic_1 = CriticNetwork(beta, input_dims, layer1_size, layer2_size,
                                      layer3_size, n_actions=n_actions, 
        ...
        self.value = ValueNetwork(beta, input_dims, layer1_size, layer2_size,
                                  layer3_size, name='value', checkpoint_dir=checkpoint_dir)
        self.target_value = ValueNetwork(beta, input_dims, layer1_size, layer2_size,
                                  layer3_size, name='target_value', checkpoint_dir=checkpoint_dir)
