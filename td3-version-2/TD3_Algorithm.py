...
class Agent:
    def __init__(self, alpha, beta, tau, env, input_dims, n_actions, layer1_size,
                 ...
                 warmup=2000, max_size=1000000, batch_size=128, 
    ...
    def choose_action(self, observation):
        ...
        self.action_noise = np.clip(np.random.normal(scale=0.1, size=self.n_actions), 
    ...
    def learn(self):
        ...
        target_actions_noise = np.clip(np.random.normal(scale=0.1, size=(self.batch_size, self.n_actions)),
                                       -self.noise, self.noise, dtype=np.float32)
