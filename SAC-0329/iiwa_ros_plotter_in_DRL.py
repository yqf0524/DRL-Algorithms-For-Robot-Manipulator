...
class Plotter2(object):
    def __init__(self):
        ...
        self.fig2 = plt.figure(4, figsize=[12, 8.8])
        self.xyz_error_graphic = self.fig2.add_subplot(2, 1, 1)
        self.rpy_error_graphic = self.fig2.add_subplot(2, 1, 2)
    ...
    def error_figure(self, iteration, xyz_error_norm, rpy_error_norm):
        self.xyz_error_graphic.cla()
        self.rpy_error_graphic.cla()
        self._error_figure()
        self.xyz_error_graphic.plot(iteration, xyz_error_norm, '-r', linewidth=0.5)
        self.rpy_error_graphic.plot(iteration, rpy_error_norm, '-r', linewidth=0.5)
        self.xyz_error_graphic.grid()
        self.rpy_error_graphic.grid()
    ...
    def _error_figure(self):
        with plt.style.context(['science', 'ieee']):
            self.xyz_error_graphic.set_title('The xyz error between TCP and goal position')
            self.xyz_error_graphic.set_xlabel('iteration')
            self.xyz_error_graphic.set_ylabel('xyz_error/[mm]')
            self.xyz_error_graphic.grid()

            self.rpy_error_graphic.set_title('The rpy error between TCP and goal orientation')
            self.rpy_error_graphic.set_xlabel('iteration')
            self.rpy_error_graphic.set_ylabel('rpy_error/[radian]')
            self.rpy_error_graphic.grid()
            plt.draw()
