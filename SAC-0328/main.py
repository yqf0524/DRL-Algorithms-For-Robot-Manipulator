...
if __name__ == '__main__':
    ...
    dp_forward.add_config_df_by_col(init_configuration)
    ...
    for i in range(epochs):
        ...
        if train_move_forward:
            dp_forward.path_joint_space_df = pd.DataFrame()
            ...
            dp_backward.path_joint_space_df = pd.DataFrame()
            ...
            if done or step_counter == steps_per_epoch:
                ...
                if train_move_forward:
                    ...
                    if forward_success:
                        ...
                        dp_backward.add_config_df_by_col(env.iiwa.current_configuration)
                    ...
                    if backward_success:
                        ...
                        dp_forward.add_config_df_by_col(env.iiwa.current_configuration)
                        train_move_forward = True
                        train_move_backward = False
